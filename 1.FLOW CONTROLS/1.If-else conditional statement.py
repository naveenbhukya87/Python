...
#Single line if-else
print("statement of single line is true") if a>10 else print("statement of single line is false")
...
{print("If Line 1"),print("If Line 2")} if a>10 else {print("Else Line a"),print("Else Line b")}
