...
print(d.rfind("g")) #19 (indicies of g in d are: 0,10,19 and maximum is 19 and it's returned)
print(d.rfind("o")) #23 (indicies of o in d are: 1,11,12,23 and maximum is 23 and it's returned)
