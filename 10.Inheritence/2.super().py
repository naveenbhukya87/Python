...
class B(A):                               #Child or sub class of A
    ...
    def mB(self,x,y):
        print(x*y)
        print(self.p*self.q)
        print(self.a*self.b)          #invoking "A" Parent class's variables "a,b" from method "
                                        # mB" of sub class "B":
b=B()
b.mB(10,4)
...
class B(A):                               #Child or sub class of A
    ...
    def mB(self,a,b):
        print(a*b)
        print(self.a*self.b)
        print(super().a*super().b)      #invoking "A" Parent class's variables "a,b" from method "mB" of sub class "B":
